...
export class VentaNotaCreditoTable1610000006800 implements MigrationInterface {
  private readonly tableName = "facturacion.movmaeventanotacredito";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createUniqueConstraint(
      this.tableName,
      new TableUnique({
        name: "UQ_CODIGO_VENTA_NOTA_CREDITO",
        columnNames: ["codigo"],
      })
    );
  }
